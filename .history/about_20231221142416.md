...
During my undergraduate studies, I validated the impact of low-rank constraints in enhancing the ability of deep learning networks to extract background information from hyperspectral imagery, earning honors for an outstanding undergraduate thesis. I conducted ablation experiments for a paper Hyperspectral Anomaly Detection Based on Adaptive Low-Rank Transformed Tensor, published in focusing on reproducing a non-open-source network.
